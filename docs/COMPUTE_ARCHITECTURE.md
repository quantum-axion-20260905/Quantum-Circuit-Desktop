...
| Full-update PEPS | bounded coordinate, finite-difference, SPSA, exact finite-torus analytic-gradient reference, and optional Torch/CUDA unrolled-autograd CTMRG path; shared resident-tensor objective seam | implicit infinite-CTMRG fixed-point gradient, gauge/χ convergence, and scalable variational update |
