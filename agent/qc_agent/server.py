...
app = FastAPI(title="Quantum Compute Agent", version="0.8.0-alpha.7")
cors_origins = [
    origin.strip()
...
@app.post("/jobs/ctmrg/dynamic/convergence")
@_sync_gpu_guard
...
@app.post("/jobs/ctmrg/dynamic/sectors")
@_sync_gpu_guard
...
@app.post("/jobs/ctmrg/boundary-mps-transfer-convergence")
@_sync_gpu_guard
