...
AsyncKind = Literal[
    ...
    "dmrg", "peps", "ctmrg", "ctmrg_convergence", "ctmrg_boundary_mps_convergence", "ctmrg_boundary_mps_transfer_convergence", "tn_estimate", "tn_amplitudes", "sweep", "cross_validate",
]
